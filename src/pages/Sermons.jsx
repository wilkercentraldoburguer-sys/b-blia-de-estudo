    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
      <div className="max-w-6xl mx-auto px-4 py-8 pb-24">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-800">Ministrações</h1>
        </div>

        {/* Banner em Desenvolvimento */}
        <Card className="bg-gradient-to-r from-purple-100 to-indigo-100 border-purple-200 mb-6">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-slate-700 mb-4">
              Em breve você terá acesso a uma biblioteca completa de ministrações organizadas por:
            </p>
